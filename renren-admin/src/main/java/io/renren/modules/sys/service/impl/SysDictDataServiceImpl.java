...
public class SysDictDataServiceImpl extends BaseServiceImpl<SysDictDataDao, SysDictDataEntity> implements SysDictDataService {
    ...
    @Override
    public List<SysDictDataEntity> listByType(String type) {
        QueryWrapper<SysDictTypeEntity> q=new QueryWrapper<>();
        q.eq("dict_type",type);
        SysDictTypeEntity sysDictTypeEntity = sysDictTypeDao.selectOne(q);

        QueryWrapper<SysDictDataEntity> qw=new QueryWrapper<>();
        qw.eq("dict_type_id",sysDictTypeEntity.getId());
        qw.orderByAsc("sort");
        List<SysDictDataEntity> sysDictDataEntities = baseDao.selectList(qw);
